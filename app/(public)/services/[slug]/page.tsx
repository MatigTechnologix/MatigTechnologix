...
export default function ServiceDetail() {
  ...
  useEffect(() => {
    fetch(`${SURL}/rest/v1/Service?slug=eq.${slug}`, { headers: H })
      .then(r => r.json())
  ...
  if (!item) return <><Nav /><main><div style={{ padding: "4rem", textAlign: "center" }}><p style={{ color: "#8892a4" }}>Service not found.</p><Link href="/services" style={{ color: "#00f5a0" }}>← Back to services</Link></div></main><Footer /></>;
    ...
    <>
      ...
      <main>
        ...
        <section className="shell" style={{ maxWidth: "760px", padding: "4rem 2rem" }}>
          <Link href="/services" style={{ color: "#00f5a0", fontSize: "0.85rem", textDecoration: "none", display: "block", marginBottom: "2rem" }}>← Back to services</Link>
