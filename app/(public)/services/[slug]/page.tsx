...
export default function ServiceDetail() {
  ...
  if (!item) return <><main><div style={{ padding: "4rem", textAlign: "center" }}><p style={{ color: "#8892a4" }}>Service not found.</p><Link href="/services" style={{ color: "#00f5a0" }}>← Back to services</Link></div></main><Footer /></>;
