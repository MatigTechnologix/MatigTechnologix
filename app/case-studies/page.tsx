...
async function getCaseStudies() {
  const res = await fetch(`${SURL}/rest/v1/CaseStudy?status=eq.Published&order=createdAt.desc`, {
  ...
  return (
    <>
      ...
      <main style={{ maxWidth: 1100, margin: "0 auto", padding: "3rem 1rem" }}>
        <h1 style={{ fontSize: "2.5rem", marginBottom: "2rem" }}>Case Studies</h1>
        {!items?.length ? <p style={{ color: "#888" }}>No case studies yet.</p> :
