  ...
  return (
    <footer className="footer">
      <div className="shell foot-grid">
        ...
        <div><h4>Company</h4><Link href="/about">About MATIG</Link><Link href="/work">Our Work</Link><Link href="/portfolio">Portfolio</Link><Link href="/case-studies">Case studies</Link><Link href="/team">Our Team</Link><Link href="/testimonials">Testimonials</Link><Link href="/blog">Blog</Link><Link href="/contact">Contact</Link></div>
